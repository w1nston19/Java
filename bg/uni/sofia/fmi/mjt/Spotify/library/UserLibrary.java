package bg.uni.sofia.fmi.mjt.Spotify.library;

import bg.uni.sofia.fmi.mjt.Spotify.exceptions.EmptyLibraryException;
import bg.uni.sofia.fmi.mjt.Spotify.exceptions.LibraryCapacityExceededException;
import bg.uni.sofia.fmi.mjt.Spotify.exceptions.PlaylistNotFoundException;
import bg.uni.sofia.fmi.mjt.Spotify.playlist.Playlist;
import bg.uni.sofia.fmi.mjt.Spotify.playlist.UserPlaylist;
